...
Official releases can be found [here](https://github.com/depinnetwork/por-consensus/releases).
...
- **Where to file issues:** <https://github.com/depinnetwork/por-consensus/issues>
...
To run a 4-node network, see the `Makefile` in the root of [the repo](https://github.com/depinnetwork/por-consensus/blob/main/Makefile) and run:
...
- CometBFT's license is [Apache 2.0](https://github.com/depinnetwork/por-consensus/blob/main/LICENSE).

## Contributing

Contributions are most welcome! See the [contributing file](https://github.com/depinnetwork/por-consensus/blob/main/CONTRIBUTING.md) for more information.
