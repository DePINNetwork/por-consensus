...
import (
	...
	netaddr "github.com/depinnetwork/por-consensus/p2p/netaddr"

	nodeinfo "github.com/depinnetwork/por-consensus/p2p/internal/nodeinfo"

	p2p "github.com/depinnetwork/por-consensus/p2p"

	transport "github.com/depinnetwork/por-consensus/p2p/transport"
)
...
func (_m *Peer) ConnState() transport.ConnState {
	...
	if len(ret) == 0 {
		panic("no return value specified for ConnState")
	}

	var r0 transport.ConnState
	if rf, ok := ret.Get(0).(func() transport.ConnState); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(transport.ConnState)
	}
