...
import (
	...
	mempool "github.com/depinnetwork/por-consensus/mempool"

	mock "github.com/stretchr/testify/mock"

	nodekey "github.com/depinnetwork/por-consensus/p2p"
...
func (_m *Mempool) Update(blockHeight int64, blockTxs types.Txs, deliverTxResponses []*v2.ExecTxResult, newPreFn mempool.PreCheckFunc, newPostFn mempool.PostCheckFunc) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(int64, types.Txs, []*v2.ExecTxResult, mempool.PreCheckFunc, mempool.PostCheckFunc) error); ok {
