...
[default in-process ABCI client](https://github.com/depinnetwork/por-consensus/blob/main/abci/client/local_client.go#L13)
and the
[default Go ABCI server](https://github.com/depinnetwork/por-consensus/blob/main/abci/server/socket_server.go#L20)
