...
[Github](https://github.com/depinnetwork/por-consensus). Before opening an issue
however, be sure to check if there's [no existing
issue](https://github.com/depinnetwork/por-consensus/issues) already.
...
is [valid and within allowed ranges](https://github.com/depinnetwork/por-consensus/blob/main/p2p/netaddr/netaddr.go#L258).
