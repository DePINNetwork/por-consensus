...
definition](https://github.com/depinnetwork/por-consensus/blob/main/types/genesis.go)).
...
- `consensus_params` ([see spec](https://github.com/depinnetwork/por-consensus/blob/main/spec/core/data_structures.md#consensusparams))
    - `block`
...
- `validators`: List of initial validators. Note this may be overridden entirely by the
  ...
  application will initialize the validator set upon `InitChain`.
    ...
    [key type](https://github.com/depinnetwork/por-consensus/blob/main/crypto/ed25519/ed25519.go#L36).
...
See the
[UPGRADING.md](https://github.com/depinnetwork/por-consensus/blob/main/UPGRADING.md)
