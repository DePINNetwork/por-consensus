...
For explanation of other functions like `PrepareProposal`, `ProcessProposal`, `FinalizeBlock`, `VoteExtension` and
`VerifyVoteExtensions` please refer to previous sections.
