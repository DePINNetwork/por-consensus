...
func (*WALMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_604b77aec4785fe5, []int{3}
}
...
type WALMessage_EventDataRoundState struct {
	EventDataRoundState *v2.EventDataRoundState `protobuf:"bytes,1,opt,name=event_data_round_state,json=eventDataRoundState,proto3,oneof" json:"event_data_round_state,omitempty"`
}
...
func (m *WALMessage) GetEventDataRoundState() *v2.EventDataRoundState {
...
func (*TimedWALMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_604b77aec4785fe5, []int{4}
}
...
func init() {
	...
	proto.RegisterType((*TimeoutInfo)(nil), "cometbft.consensus.v2.TimeoutInfo")
	proto.RegisterType((*EndHeight)(nil), "cometbft.consensus.v2.EndHeight")
...
var fileDescriptor_604b77aec4785fe5 = []byte{
	...
	,
}
