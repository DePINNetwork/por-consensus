...
import (
	fmt "fmt"
	v1 "github.com/depinnetwork/por-consensus/api/cometbft/libs/bits/v1"
...
type NewValidBlock struct {
	Height             int64            `protobuf:"varint,1,opt,name=height,proto3" json:"height,omitempty"`
	Round              int32            `protobuf:"varint,2,opt,name=round,proto3" json:"round,omitempty"`
	BlockPartSetHeader v2.PartSetHeader `protobuf:"bytes,3,opt,name=block_part_set_header,json=blockPartSetHeader,proto3" json:"block_part_set_header"`
...
func (m *NewValidBlock) GetBlockPartSetHeader() v2.PartSetHeader {
	if m != nil {
		return m.BlockPartSetHeader
	}
	return v2.PartSetHeader{}
}
...
func (m *Proposal) GetProposal() v2.Proposal {
	if m != nil {
		return m.Proposal
	}
	return v2.Proposal{}
...
func (*ProposalPOL) Descriptor() ([]byte, []int) {
	return fileDescriptor_1fbfa7f975842dd1, []int{3}
}
...
type BlockPart struct {
	Height int64   `protobuf:"varint,1,opt,name=height,proto3" json:"height,omitempty"`
	Round  int32   `protobuf:"varint,2,opt,name=round,proto3" json:"round,omitempty"`
	Part   v2.Part `protobuf:"bytes,3,opt,name=part,proto3" json:"part"`
}
...
func (*BlockPart) Descriptor() ([]byte, []int) {
	return fileDescriptor_1fbfa7f975842dd1, []int{4}
}
...
func (m *BlockPart) GetPart() v2.Part {
	if m != nil {
		return m.Part
	}
	return v2.Part{}
...
func (*Vote) Descriptor() ([]byte, []int) {
	return fileDescriptor_1fbfa7f975842dd1, []int{5}
}
...
type HasVote struct {
	Height int64            `protobuf:"varint,1,opt,name=height,proto3" json:"height,omitempty"`
	Round  int32            `protobuf:"varint,2,opt,name=round,proto3" json:"round,omitempty"`
	Type   v2.SignedMsgType `protobuf:"varint,3,opt,name=type,proto3,enum=cometbft.types.v2.SignedMsgType" json:"type,omitempty"`
...
func (*HasVote) Descriptor() ([]byte, []int) {
	return fileDescriptor_1fbfa7f975842dd1, []int{6}
}
...
func (m *HasVote) GetType() v2.SignedMsgType {
	if m != nil {
		return m.Type
	}
	return v2.UnknownType
}
...
type VoteSetMaj23 struct {
	...
	Round   int32            `protobuf:"varint,2,opt,name=round,proto3" json:"round,omitempty"`
	Type    v2.SignedMsgType `protobuf:"varint,3,opt,name=type,proto3,enum=cometbft.types.v2.SignedMsgType" json:"type,omitempty"`
	BlockID v2.BlockID       `protobuf:"bytes,4,opt,name=block_id,json=blockId,proto3" json:"block_id"`
}
...
func (*VoteSetMaj23) Descriptor() ([]byte, []int) {
	return fileDescriptor_1fbfa7f975842dd1, []int{7}
}
...
func (m *VoteSetMaj23) GetType() v2.SignedMsgType {
	if m != nil {
		return m.Type
	}
	return v2.UnknownType
...
func (m *VoteSetMaj23) GetBlockID() v2.BlockID {
	if m != nil {
		return m.BlockID
	}
	return v2.BlockID{}
...
func (*VoteSetBits) Descriptor() ([]byte, []int) {
	return fileDescriptor_1fbfa7f975842dd1, []int{8}
}
...
func (m *VoteSetBits) GetType() v2.SignedMsgType {
	if m != nil {
		return m.Type
	}
	return v2.UnknownType
...
func (m *VoteSetBits) GetBlockID() v2.BlockID {
	if m != nil {
		return m.BlockID
	}
	return v2.BlockID{}
...
func (*HasProposalBlockPart) Descriptor() ([]byte, []int) {
	return fileDescriptor_1fbfa7f975842dd1, []int{9}
}
...
func (*Message) Descriptor() ([]byte, []int) {
	return fileDescriptor_1fbfa7f975842dd1, []int{10}
}
...
func init() {
	proto.RegisterType((*NewRoundStep)(nil), "cometbft.consensus.v2.NewRoundStep")
	proto.RegisterType((*NewValidBlock)(nil), "cometbft.consensus.v2.NewValidBlock")
	proto.RegisterType((*Proposal)(nil), "cometbft.consensus.v2.Proposal")
	proto.RegisterType((*ProposalPOL)(nil), "cometbft.consensus.v2.ProposalPOL")
	proto.RegisterType((*BlockPart)(nil), "cometbft.consensus.v2.BlockPart")
	proto.RegisterType((*Vote)(nil), "cometbft.consensus.v2.Vote")
	proto.RegisterType((*HasVote)(nil), "cometbft.consensus.v2.HasVote")
	proto.RegisterType((*VoteSetMaj23)(nil), "cometbft.consensus.v2.VoteSetMaj23")
	proto.RegisterType((*VoteSetBits)(nil), "cometbft.consensus.v2.VoteSetBits")
...
var fileDescriptor_1fbfa7f975842dd1 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= v2.SignedMsgType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
