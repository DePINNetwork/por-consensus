...
// source: cometbft/state/v2/types.proto
...
type LegacyABCIResponses struct {
	DeliverTxs []*v2.ExecTxResult  `protobuf:"bytes,1,rep,name=deliver_txs,json=deliverTxs,proto3" json:"deliver_txs,omitempty"`
...
func (*LegacyABCIResponses) Descriptor() ([]byte, []int) {
	return fileDescriptor_c6c696255fbe933e, []int{0}
}
...
func (m *LegacyABCIResponses) GetDeliverTxs() []*v2.ExecTxResult {
	if m != nil {
		return m.DeliverTxs
	}
	return nil
...
func (*ResponseBeginBlock) Descriptor() ([]byte, []int) {
	return fileDescriptor_c6c696255fbe933e, []int{1}
}
...
func (m *ResponseBeginBlock) GetEvents() []v2.Event {
	if m != nil {
		return m.Events
	}
	return nil
...
type ResponseEndBlock struct {
	ValidatorUpdates      []v2.ValidatorUpdate `protobuf:"bytes,1,rep,name=validator_updates,json=validatorUpdates,proto3" json:"validator_updates"`
	ConsensusParamUpdates *v21.ConsensusParams `protobuf:"bytes,2,opt,name=consensus_param_updates,json=consensusParamUpdates,proto3" json:"consensus_param_updates,omitempty"`
...
func (*ResponseEndBlock) Descriptor() ([]byte, []int) {
	return fileDescriptor_c6c696255fbe933e, []int{2}
}
...
func (m *ResponseEndBlock) GetValidatorUpdates() []v2.ValidatorUpdate {
	if m != nil {
...
func (m *ResponseEndBlock) GetConsensusParamUpdates() *v21.ConsensusParams {
	if m != nil {
...
func (m *ResponseEndBlock) GetEvents() []v2.Event {
	if m != nil {
		return m.Events
	}
	return nil
...
type ValidatorsInfo struct {
	ValidatorSet      *v21.ValidatorSet `protobuf:"bytes,1,opt,name=validator_set,json=validatorSet,proto3" json:"validator_set,omitempty"`
...
func (*ValidatorsInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c6c696255fbe933e, []int{3}
}
...
func (m *ValidatorsInfo) GetValidatorSet() *v21.ValidatorSet {
	if m != nil {
...
type ConsensusParamsInfo struct {
	ConsensusParams   v21.ConsensusParams `protobuf:"bytes,1,opt,name=consensus_params,json=consensusParams,proto3" json:"consensus_params"`
	LastHeightChanged int64               `protobuf:"varint,2,opt,name=last_height_changed,json=lastHeightChanged,proto3" json:"last_height_changed,omitempty"`
}
...
func (*ConsensusParamsInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c6c696255fbe933e, []int{4}
}
...
func (m *ConsensusParamsInfo) GetConsensusParams() v21.ConsensusParams {
	if m != nil {
		return m.ConsensusParams
	}
	return v21.ConsensusParams{}
}
...
type ABCIResponsesInfo struct {
	...
	FinalizeBlock       *v2.FinalizeBlockResponse `protobuf:"bytes,3,opt,name=finalize_block,json=finalizeBlock,proto3" json:"finalize_block,omitempty"`
}
...
func (*ABCIResponsesInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c6c696255fbe933e, []int{5}
}
...
func (m *ABCIResponsesInfo) GetFinalizeBlock() *v2.FinalizeBlockResponse {
	if m != nil {
...
func (*Version) Descriptor() ([]byte, []int) {
	return fileDescriptor_c6c696255fbe933e, []int{6}
}
...
func (m *Version) GetConsensus() v1.Consensus {
	if m != nil {
		return m.Consensus
	}
	return v1.Consensus{}
...
type State struct {
	...
	LastBlockID     v21.BlockID `protobuf:"bytes,4,opt,name=last_block_id,json=lastBlockId,proto3" json:"last_block_id"`
	...
	NextValidators              *v21.ValidatorSet `protobuf:"bytes,6,opt,name=next_validators,json=nextValidators,proto3" json:"next_validators,omitempty"`
	Validators                  *v21.ValidatorSet `protobuf:"bytes,7,opt,name=validators,proto3" json:"validators,omitempty"`
	LastValidators              *v21.ValidatorSet `protobuf:"bytes,8,opt,name=last_validators,json=lastValidators,proto3" json:"last_validators,omitempty"`
	...
	ConsensusParams                  v21.ConsensusParams `protobuf:"bytes,10,opt,name=consensus_params,json=consensusParams,proto3" json:"consensus_params"`
...
func (*State) Descriptor() ([]byte, []int) {
	return fileDescriptor_c6c696255fbe933e, []int{7}
}
...
func (m *State) GetLastBlockID() v21.BlockID {
	if m != nil {
...
func (m *State) GetNextValidators() *v21.ValidatorSet {
	if m != nil {
...
func (m *State) GetValidators() *v21.ValidatorSet {
	if m != nil {
		return m.Validators
	}
	return nil
...
func (m *State) GetLastValidators() *v21.ValidatorSet {
	if m != nil {
...
func (m *State) GetConsensusParams() v21.ConsensusParams {
	if m != nil {
		return m.ConsensusParams
	}
	return v21.ConsensusParams{}
...
func init() {
	proto.RegisterType((*LegacyABCIResponses)(nil), "cometbft.state.v2.LegacyABCIResponses")
	proto.RegisterType((*ResponseBeginBlock)(nil), "cometbft.state.v2.ResponseBeginBlock")
	proto.RegisterType((*ResponseEndBlock)(nil), "cometbft.state.v2.ResponseEndBlock")
	proto.RegisterType((*ValidatorsInfo)(nil), "cometbft.state.v2.ValidatorsInfo")
	proto.RegisterType((*ConsensusParamsInfo)(nil), "cometbft.state.v2.ConsensusParamsInfo")
	proto.RegisterType((*ABCIResponsesInfo)(nil), "cometbft.state.v2.ABCIResponsesInfo")
	proto.RegisterType((*Version)(nil), "cometbft.state.v2.Version")
	proto.RegisterType((*State)(nil), "cometbft.state.v2.State")
}

func init() { proto.RegisterFile("cometbft/state/v2/types.proto", fileDescriptor_c6c696255fbe933e) }

var fileDescriptor_c6c696255fbe933e = []byte{
	...
	0x10, 0x36, 0xa3, 0xc4, 0x92, 0x46, 0xd1, 0x8f, 0x57, 0x4d, 0xc3, 0xb8, 0x8d, 0xe4, 0xa8, 0x4d,
	0x6a, 0x14, 0x05, 0x85, 0xa8, 0xb7, 0x5e, 0xd2, 0x50, 0x4a, 0x60, 0x01, 0x6e, 0x50, 0xd0, 0x6e,
	...
	,
}
...
func (m *LegacyABCIResponses) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.DeliverTxs = append(m.DeliverTxs, &v2.ExecTxResult{})
...
func (m *ValidatorsInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.ValidatorSet == nil {
				m.ValidatorSet = &v21.ValidatorSet{}
			}
...
func (m *ABCIResponsesInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.FinalizeBlock == nil {
				m.FinalizeBlock = &v2.FinalizeBlockResponse{}
			}
...
func (m *State) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if m.NextValidators == nil {
				m.NextValidators = &v21.ValidatorSet{}
			}
		...
		case 8:
			...
			if m.LastValidators == nil {
				m.LastValidators = &v21.ValidatorSet{}
			}
