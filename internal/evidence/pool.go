...
func isEmpty(evidenceDB cmtdb.DB) bool {
...
func NewPool(evidenceDB cmtdb.DB, stateDB sm.Store, blockStore BlockStore, options ...PoolOptions) (*Pool, error) {
...
func (evpool *Pool) listEvidence(prefixKey []byte, maxBytes int64) ([]types.Evidence, int64, error) {
	...
	iter, err := cmtdb.IteratePrefix(evpool.evidenceStore, prefixKey)
	if err != nil {
...
func (evpool *Pool) removeExpiredPendingEvidence() (int64, time.Time) {
	iter, err := cmtdb.IteratePrefix(evpool.evidenceStore, evpool.dbKeyLayout.PrefixToBytesPending())
	if err != nil {
